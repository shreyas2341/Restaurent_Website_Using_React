    ...
    return (
        <Navbar className='add py-3 ' bg='black' variant='dark'>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <Nav className='end'>
                    <Nav.Link href="#deets" id='e1'>
                        Log In / Register</Nav.Link>
                    
                    <Nav.Link eventKey={2} href="#memes" id='e2'>
